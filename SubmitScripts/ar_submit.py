...
def main():
    ...
    package['cmdline'] = 'Render -s QB_FRAME_NUMBER -e QB_FRAME_NUMBER -rd /render/jmacey/output -r arnold -proj /render/jmacey/FarmTest -cam persp /render/jmacey/FarmTest/scenes/ArnoldTest.ma '
    ...
    env={"HOME" :"/render/jmacey",  
                ...
                "LD_LIBRARY_PATH" : f"/usr/lib/:/usr/lib64:/render/jmacey/libs:{MAYA_ROOT}/lib/",
