...
def main():
    ...
    job = {}
    job['name'] = 'VRay With Textures, Shaders and IBL'
    ...
    package['cmdline'] = '/opt/software/vray_builds/maya_vray/bin/vray.bin   -sceneFile=/render/jmacey/FarmTest/scenes/VR2.vrscene -remapPath="/home/jmacey/RenderFarmTests/MayaProjects/=/render/jmacey/"   -display=0 -frames=QB_FRAME_NUMBER -imgFile=../images/TestScene.exr'
    ...
    job['env']={"HOME" :"/render/jmacey",  
                ...
                "VRAY_ASSETS_PATH" : "shaders:sourceImages" }
