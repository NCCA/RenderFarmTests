...
print
print "---------------------------------------------------------------"
print "             ncca Renderfarm Tool for HBatch Mantra            "
print
...
cmd_flags = "-V -f QB_FRAME_START QB_FRAME_END -i QB_FRAME_STEP "+rendererNode
jobCmdLine = "cd /tmp; echo \"render "+cmd_flags+"\" > ${UID}-QB_FRAME_NUMBER; cd "+jobRenderEXEpath+" hbatch -R -c /tmp/${UID}-QB_FRAME_NUMBER \""+jobSceneFile+"\"; rm /tmp/${UID}-QB_FRAME_NUMBER"
