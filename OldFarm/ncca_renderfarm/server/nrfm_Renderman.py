...
# BUG: RACE
# There is a race condition bug with the renderfarm, so we need
# to keep the number of instances to 1 until it is fixed.

print
print "---------------------------------------------------------------"
print "               ncca Renderfarm Tool for Renderman              "
print
...
# BUG: RACE #
#jobCmdLine = jobRenderEXEpath+" -renderer renderman -proj \""+jobProjectPath+"\" -rd \""+jobRdImages+"\" -s QB_FRAME_START -e QB_FRAME_END \""+jobSceneFile+"\""
#------------#
jobCmdLine = jobRenderEXEpath+" -renderer renderman -proj \""+jobProjectPath+"\" -rd \""+jobRdImages+"\" -s "+startFrame+" -e "+endFrame+" \""+jobSceneFile+"\""
#############
...
environmentVars = { \
                    ...
                    'PYTHONPATH' : '/opt/software/pixar/RenderManForMaya-'+PRMAN_VERSION_ON_SERVER+'/scripts:/opt/software/pixar/RenderManProServer-'+PRMAN_VERSION_ON_SERVER+'/bin:/opt/software/autodesk/arnold/maya'+MAYA_VERSION_ON_SERVER+'/scripts/arnold:/opt/software/autodesk/arnold/maya'+MAYA_VERSION_ON_SERVER+'/scripts/mtoa:/opt/software/autodesk/arnold/maya'+MAYA_VERSION_ON_SERVER+'/scripts', \
                    'LD_LIBRARY_PATH' : '$LD_LIBRARY_PATH:/opt/software/lib:/opt/software/autodesk/maya'+MAYA_VERSION_ON_SERVER+'/lib:', \
                    'AW_LOCATION' : '/opt/software/autodesk', \
                    'PIXAR_LICENSE_FILE' : PIXAR_LICENSE_SERVER, \
                    'ADSKFLEX_LICENSE_FILE' : '@'+MAYA_LICENSE_SERVER, \
                    'MAYA_RENDER_DESC_PATH' : '/opt/software/pixar/RenderManForMaya-'+PRMAN_VERSION_ON_SERVER+'/etc:/opt/software/autodesk/arnold/maya'+MAYA_VERSION_ON_SERVER, \
                    'HOME' : '/render/'+userName, \
                    'MAYA_PLUG_IN_PATH' : '/opt/software/pixar/RenderManForMaya-'+PRMAN_VERSION_ON_SERVER+'/plug-ins:/opt/software/autodesk/arnold/maya'+MAYA_VERSION_ON_SERVER+'/plug-ins', \
                    }
